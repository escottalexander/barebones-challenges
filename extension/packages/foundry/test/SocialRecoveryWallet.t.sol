...
contract SocialRecoveryWalletTest is Test {
  ...
  function testCallCanForwardEth() public {
    ...
    socialRecoveryWallet.call{ value: amountToSend }(
  ...
  function testCallCanExecuteExternalTransactions() public {
    ...
    socialRecoveryWallet.call(
      address(dai),
      0,
      abi.encodeWithSignature("transfer(address,uint256)", alice, 500)
    );
  ...
  function helperChangeOwnerWithThreshold(
    address _newOwner
  ) internal {
    vm.prank(guardian0);
